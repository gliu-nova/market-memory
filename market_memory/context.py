...
def _short_subject(
    *,
    ...
    _LABELS = {
        ...
        "treasury_2y": "2Y yield moves",
        "yield_curve": "yield curve moves",
        "qqq": "QQQ moves",
        "bond_etf_agg": "AGG moves",
        "bond_etf_bnd": "BND moves",
        "crypto_etf_ibit": "IBIT moves",
        "crypto_etf_fbtc": "FBTC moves",
        "dark_pool_volume": "dark pool volume spikes",
        "dark_pool_pct": "dark pool % extremes",
